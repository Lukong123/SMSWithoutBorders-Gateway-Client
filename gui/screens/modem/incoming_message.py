...
#         self.modem_handler = modem_handler
#         self.modem_name = modem_name
#         self.incoming_messages = []  # List to store messages

#         # Setup display for messages
#         self.message_display = Gtk.TextView()
#         self.message_display.set_editable(False)
#         self.message_display_buffer = self.message_display.get_buffer()
#         self.pack_start(self.message_display, True, True, 0)

#     def display_new_message(self, message):
#         print(f"Displaying new message in IncomingMessageWindow: {message}")
#         self.incoming_messages.append(message)
#         message_text = f"{message}\n"
#         self.message_display_buffer.insert(self.message_display_buffer.get_end_iter(), message_text)
...
#         print("Displaying all messages in IncomingMessageWindow...")
