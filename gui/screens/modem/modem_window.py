...
class ModemWindow(Gtk.Window):
    def __init__(self, modem_properties, modem_name, modem_path, modem_handler):
        ...
        self.incoming_messages = self.modem_handler.load_incoming(modem_path)
        ...
        # Create the self.stack to switch between views
        ...
        home_modem_event_box.connect("button-press-event", self.on_home_modem_clicked, self.stack)
        ...
        send_event_box.connect("button-press-event", self.on_send_clicked, self.stack)
        ...
        incoming_event_box.connect("button-press-event", self.on_incoming_clicked, self.stack)
        ...
        outgoing_event_box.connect("button-press-event", self.on_outgoing_clicked, self.stack)
        ...
        failed_event_box.connect("button-press-event", self.on_failed_clicked, self.stack)
        ...
        encrypted_event_box.connect("button-press-event", self.on_encrypted_clicked, self.stack)
        ...
        message_forwarding_event_box.connect("button-press-event", self.on_message_forwarding_clicked, self.stack)
        ...
        export_event_box.connect("button-press-event", self.on_export_clicked, self.stack)
        ...
        about_event_box.connect("button-press-event", self.on_about_clicked, self.stack)
        ...
        # # gatewaysever
        # gateway_server_window = Gtk.Label()
        # about_label.set_text("Gateway Server")
        # about_label.set_name("side_label")
        # about_label.set_margin_bottom(8)
        # about_label.set_margin_top(8)
        # about_event_box = Gtk.EventBox()
    ...
    def initialize_views(self):
        ...
        self.stack.add_named(home_modem_view, "home_modem")
        ...
        self.stack.add_named(outgoing_view, "outgoing")

        # failed view
        failed_view = FailedMessageWindow()
        self.stack.add_named(failed_view, "failed")

        # encrypted view
        encrypted_view = EncryptedMessageWindow()
        self.stack.add_named(encrypted_view, "encrypted")

        # message forwarding view
        # message_forwarding_view = MessageForwardingWindow(self.stack)
        # self.stack.add_named(message_forwarding_view, "message_forwarding")

        message_forwarding_window = MessageForwardingWindow(self.stack)
        self.stack.add_named(message_forwarding_window, "message_forwarding")

        # Assuming sidebar contains the message_forwarding_event_box
        # Connect the sidebar button to self.on_message_forwarding_clicked
        # message_forwarding_event_box = Gtk.EventBox()
        # message_forwarding_event_box.connect("button-press-event", self.on_message_forwarding_clicked)

        # export view
        export_view = ExportMessageWindow()
        self.stack.add_named(export_view, "export")

        # about view
        about_view = AboutWindow(self.modem_properties, self.modem_name, self.modem_handler)
        self.stack.add_named(about_view, "about")



    def on_home_modem_clicked(self, widget, event, *args):
        self.stack.set_visible_child_name("home_modem")

    def on_send_clicked(self, widget, event, *args):
    ...
    def on_failed_clicked(self, widget, event, *args):
        self.stack.set_visible_child_name("failed")
        self.set_active_label("failed_label")
   
    def on_encrypted_clicked(self, widget, event, *args):
        self.stack.set_visible_child_name("encrypted")
        self.set_active_label("encrypted_label")

    def on_message_forwarding_clicked(self, widget, event, *args):

        print(f"Arguments received in on_message_forwarding_clicked: {args}")
        self.stack.set_visible_child_name("message_forwarding")
        self.set_active_label("message_forwarding_label")

    def on_export_clicked(self, widget, event, *args):
        self.stack.set_visible_child_name("export")
        self.set_active_label("export_label")

    def on_about_clicked(self, widget, event, *args):
        self.stack.set_visible_child_name("about")
        self.set_active_label("about_label")

    def on_test_clicked(self, widget, event, *args):
